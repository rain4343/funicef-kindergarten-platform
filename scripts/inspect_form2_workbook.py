...
path = Path('/home/ubuntu/upload/Form2.xlsx')
    ...
    for row in ws.iter_rows():
        for cell in row:
            if cell.value is not None:
                print('STYLE', cell.coordinate, 'value=',repr(cell.value), 'font=',cell.font.name,cell.font.sz,cell.font.bold,cell.font.italic, 'fill=',cell.fill.fill_type,cell.fill.fgColor.type,cell.fill.fgColor.rgb, 'align=',cell.alignment.horizontal,cell.alignment.vertical,cell.alignment.wrap_text, 'border=',cell.border.left.style,cell.border.right.style,cell.border.top.style,cell.border.bottom.style, 'numfmt=',cell.number_format)
